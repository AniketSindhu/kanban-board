    ...
    (set) => ({
      tasks: [
        ...
        },
        {
          ...
          description: 'Next.js + Tailwind + Neon DB. Pages: Landing, About, Projects, Blog, Knowledge, Contact. Theme: Cyberpunk neon (blue/purple), minimal but eye-catching, no bullshit. Brand theme documented in memory/suki-brand-theme.md',
          createdAt: new Date().toISOString(),
        },
        {
          id: 'website-2',
