  ...
  persist(
    (set) => ({
      tasks: [
        ...
        {
          id: 'website-3',
          title: 'Setup ProtonMail access (suk1suk1@proton.me)',
          column: 'backlog',
          priority: 'high',
          tags: ['email', 'protonmail', 'infrastructure'],
          description: 'Configure ProtonMail Bridge or access emails. Check inbox, setup notifications, integrate with workflow if needed.',
          createdAt: new Date().toISOString(),
        },
        {
          id: 'twitter-6',
          title: 'Upload profile photo + cover photo to X',
          column: 'blockers',
          priority: 'high',
        ...
        {
          id: 'infra-5',
          title: 'Fix kanban board - make cards draggable',
          column: 'blockers',
          priority: 'high',
          tags: ['kanban', 'bug', 'ux'],
          description: 'User reports cannot move cards. Need to check dnd-kit implementation. Is drag-and-drop actually working? Check browser console for errors.',
          createdAt: new Date().toISOString(),
        },
        {
          id: 'infra-6',
          title: 'Show daily token usage in kanban UI',
          column: 'building',
          priority: 'high',
          tags: ['kanban', 'feature', 'cost-tracking'],
          description: 'Add component to display: Today: X tasks | Y tokens | $Z cost. Use getTodayStats() from tokenTracker.',
          createdAt: new Date().toISOString(),
        },
        {
          id: 'infra-7',
          title: 'Create .env.example for kanban + Neon connection',
          column: 'building',
          priority: 'high',
          tags: ['kanban', 'documentation', 'env'],
          description: 'Document required env vars: DATABASE_URL for Neon, any API keys. Currently using localStorage, need to explain migration path.',
          createdAt: new Date().toISOString(),
        },
        {
          id: 'website-2',
          title: 'Create SUKI brand assets',
          column: 'backlog',
          priority: 'high',
          tags: ['website', 'branding', 'design'],
          description: 'Logo (⚡ symbol), color palette (electric blue #00F0FF, purple #B829DD), typography (Space Grotesk), OG images. Consistent across all platforms.',
          createdAt: new Date().toISOString(),
        },
        {
          id: 'suki-1',
